...
plt.annotate('A', xy=(0.02, 0.91), xycoords='axes fraction')
plt.subplot(222)
t=12
...
m.drawparallels(parallels,labels=[1,0,0,0],**tickfont)
m.drawmeridians(meridians,labels=[0,0,0,1],**tickfont)
plt.annotate('B', xy=(0.02, 0.91), xycoords='axes fraction')
plt.subplot(223)
t=24
...
m.drawparallels(parallels,labels=[1,0,0,0],**tickfont)
m.drawmeridians(meridians,labels=[0,0,0,1],**tickfont)
plt.annotate('C', xy=(0.02, 0.91), xycoords='axes fraction')
plt.subplot(224)
t=48
...
m.drawparallels(parallels,labels=[1,0,0,0],**tickfont)
m.drawmeridians(meridians,labels=[0,0,0,1],**tickfont)
plt.annotate('D', xy=(0.02, 0.91), xycoords='axes fraction')
plt.savefig('ocean_s1_Backward-Time_FTLE_Comparison_v3.png', transparent=False, bbox_inches='tight',dpi=300)
plt.savefig('ocean_s1_Backward-Time_FTLE_Comparison_v3.eps', transparent=False, bbox_inches='tight')
#plt.close('all')
