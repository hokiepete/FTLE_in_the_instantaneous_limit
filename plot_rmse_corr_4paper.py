...
plt.ylim([0,0.175])
ax1=add_subplot_axes(ax,rect = [0.09,0.54,0.37,0.37])
f = sio.loadmat('dg_plot_data_shortime.mat')
t = -f['time'][0]
rmse2 = f['rmse2'][0]
rmse3 = f['rmse3'][0]
...
ax1.plot(-t[0:end],rmse2[0:end],'m-')
ax1.plot(-t[0:end],rmse3[0:end],'k-')
ax1.ticklabel_format(style='sci',axis='y', scilimits=(0,0))
#plt.xlim([0,400])
...
f = sio.loadmat('dg3d_plot_data_big.mat')
t = -f['time'][0]
rmse2 = f['rmse2'][0]
rmse1 = f['rmse1'][0]
rmse3 = f['rmse3'][0]
...
plt.savefig('dg3d_rmse.png', transparent=False, bbox_inches='tight',pad_inches=0.03)
#'''
width = 4.5#5+3/8
height = width/1.61803399
figSize = (width,height)
...
#plt.xlim([0,0.7])
ax1=add_subplot_axes(ax,rect = [0.09,0.54,0.37,0.37])
f = sio.loadmat('abc_plot_data_shorttime.mat')
t = -f['time'][0]
rmse2 = f['rmse2'][0]
rmse3 = f['rmse3'][0]
...
plt.savefig('abc_rmse_a.png', transparent=False, bbox_inches='tight',pad_inches=0.03)
