...
font = 'cmr'
width = 5+3/8
fig=figure('units','inch','position',[0,0,width,width/2],'DefaultTextFontName', font, 'DefaultAxesFontName', font);
i = 1
subplot(1,2,1)
hold on
FV.vertices=squeeze(verts(i,:,:));
...
axis equal tight;
view(az2,el2)
saveas(fig,'attracting_ilcs_4defence_1.eps','epsc')
...
saveas(fig,'attracting_ilcs_4defence_2.eps','epsc')
%{
i = n
subplot(3,2,5)
hold on
